 ...
 public class Harmony
 {
   ...
   public static final int[] SCALE_WHOLE_TONE = { 0, 2, 4, 6, 8, 10 };
   public static final int[] SCALE_DIMINISHED_WH = { 0, 2, 3, 5, 6, 8, 9, 11 };
   public static final int[] SCALE_DIMINISHED_HW = { 0, 1, 3, 4, 6, 7, 9, 10 };
 
   public static final int[][] SCALE_ALL = { SCALE_NATURAL_MINOR, SCALE_MELODIC_MINOR, SCALE_MAJOR, SCALE_HUNGARIAN_MINOR, SCALE_DORIAN, SCALE_PHRYGIAN, SCALE_LYDIAN, SCALE_MIXOLYDIAN, SCALE_LOCRIAN, SCALE_BLUES, SCALE_PENTATONIC_MINOR, SCALE_PENTATONIC_MAJOR, SCALE_WHOLE_TONE, SCALE_DIMINISHED_WH, SCALE_DIMINISHED_HW };
